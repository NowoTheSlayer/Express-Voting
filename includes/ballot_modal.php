    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <?php
                $id = $voter_data['id'];
                $sql = "SELECT *, candidates.firstname AS canfirst, candidates.lastname AS canlast FROM votes LEFT JOIN candidates ON candidates.id=votes.candidate_id LEFT JOIN position ON position.parent_id=votes.position_id WHERE voters_id = '$id'";
                $query = $db->query($sql);
